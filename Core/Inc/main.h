...
/* Private defines -----------------------------------------------------------*/
#define MAX30003_CS_Pin GPIO_PIN_2
...
#define BLE_BTN_Pin GPIO_PIN_15
#define BLE_BTN_GPIO_Port GPIOB
#define CHARGE_Pin GPIO_PIN_12
#define CHARGE_GPIO_Port GPIOB
#define LED_SWITCH_Pin GPIO_PIN_4
#define LED_SWITCH_GPIO_Port GPIOB
